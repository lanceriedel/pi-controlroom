...
3. Tell Lance in two lines where the control room is and how to use it.
...
- Keep `docs/briefs/STATUS.md` current after every launch/integration: workers table, decisions waiting on Lance.
- Decisions are serial (one question to Lance), execution is parallel (many workers).
